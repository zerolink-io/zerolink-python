...
from ...models.create_fact_response import CreateFactResponse
from ...models.create_triple import CreateTriple
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[CreateFactResponse, HTTPValidationError]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = CreateFactResponse.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    """ Post User Fact
     ...
     Add an user-defined fact to a session.
...
def sync(
    *,
    ...
    Returns:
        Union[CreateFactResponse, HTTPValidationError]
     """
