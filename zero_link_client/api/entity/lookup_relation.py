...
def _get_kwargs(
    ...
    return {
        "method": "get",
        "url": "/desc/relation/search/{name}".format(name=name,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[HTTPValidationError, List['Relation']]]:
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in (_response_200):
            response_200_item = Relation.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    r""" Desc Relation
     ...
     Search for a relation by name, e.g. \"educated at\"
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['Relation']]
     """
