...
def _get_kwargs(
    ...
    return {
        "method": "get",
        "url": "/session/{session_id}/entity".format(session_id=session_id,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[HTTPValidationError, List['GenericEntity']]]:
    if response.status_code == HTTPStatus.OK:
        ...
        for response_200_item_data in (_response_200):
            response_200_item = GenericEntity.from_dict(response_200_item_data)
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[HTTPValidationError, List['GenericEntity']]
     """
