...
def _get_kwargs(
    ...
    return {
        "method": "delete",
        "url": "/session/{session_id}".format(session_id=session_id,),
    }


def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[Union[DeleteSessionResponseDeleteSession, HTTPValidationError]]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[Union[DeleteSessionResponseDeleteSession, HTTPValidationError]]:
    return Response(
